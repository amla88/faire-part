...
export class AdminFamilleDetailComponent implements OnInit {
  ...
  createPersonGroup(data?: any): FormGroup {
    return this.fb.group({
      ...
      invite_anniversaire: [!!data?.invite_anniversaire],
      present_anniversaire: [!!data?.present_anniversaire],
  ...
  private async savePersons(): Promise<void> {
    ...
    const toUpsert = this.persons.controls.map((ctrl) => {
      ...
      const personData: any = {
        ...
        invite_anniversaire: !!g.get('invite_anniversaire')?.value,
        present_anniversaire: !!g.get('present_anniversaire')?.value,
